...
function InstantConsultationContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      <Header />
      <main className="container py-8 px-4 mt-16">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4 py-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Connect with top specialists instantly. No waiting, no scheduling - just click and start!
            </p>
          </div>
              ...
              {specialists.map((specialist) => (
                ...
                >
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {/* Action Button */}
                    <Button 
                      className="w-full h-12 text-base font-semibold group-hover:shadow-lg transition-all"
                      size="lg"
